...
if (localStorage.getItem(1) === null) {
   ...
   fetch("https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=b55e8bac31f54317a6a245f3c247dcac")
  .then((data) => {
  ...
  .then((comObj) => {
    let art = comObj.articles;

    localStorage.setItem(1,JSON.stringify(art))
...
{
let resu =  JSON.parse(localStorage.getItem(1))
  console.log(resu)
